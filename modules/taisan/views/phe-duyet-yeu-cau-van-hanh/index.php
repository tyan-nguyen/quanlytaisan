...
if ($requestId) {
    $modalUrl = Yii::$app->urlManager->createUrl(['/taisan/phe-duyet-yeu-cau-van-hanh/approve', 'id' => $requestId]);
    $script = <<<JS
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#ajaxCrudModal').find('.modal-body').html(data.content);
                $('#ajaxCrudModal').find('.modal-footer').html(data.footer); // Add this line
