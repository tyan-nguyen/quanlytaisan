...
$this->title = 'Ts Yeu Cau Van Hanh Cts';
...
<div class="ts-yeu-cau-van-hanh-ct-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Ts Yeu Cau Van Hanh Cts','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách Ts Yeu Cau Van Hanh Cts</em>',
