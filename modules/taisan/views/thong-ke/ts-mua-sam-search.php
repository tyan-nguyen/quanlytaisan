...
if($model->tuNgay){
    $model->tuNgay = $custom->convertYMDToDMY($model->tuNgay);
}
if($model->denNgay){
    $model->denNgay = $custom->convertYMDToDMY($model->denNgay);
}
?>
<style>
...
<div class="thiet-bi-search">
	...
	<?= $form->field($model, 'coPhieuMuaSam')->checkbox(['label'=>'Theo quy trình mua sắm']) ?>
	
	<?= $form->field($model, 'coNgayMua')->checkbox(['label'=>'Có ngày mua hàng']) ?>
    ...
    <?php // $form->field($model, 'ma_thiet_bi')->textInput(['maxlength' => true]) ?>

    <?php // $form->field($model, 'ten_thiet_bi')->textInput(['maxlength' => true]) ?>
