...
/**
 * TheoDoiVanHanhSearch represents the model behind the search form about `app\models\TsYeuCauVanHanh`.
 */
class TheoDoiVanHanhSearch extends TsYeuCauVanHanh
{
    /**
     * @inheritdoc
     */
