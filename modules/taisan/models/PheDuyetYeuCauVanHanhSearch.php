...
/**
 * PheDuyetYeuCauVanHanhSearch represents the model behind the search form about `app\models\YeuCauVanHanh`.
 */
class PheDuyetYeuCauVanHanhSearch extends YeuCauVanHanh
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params, $cusomSearch=NULL)
    {
		...
		if($cusomSearch != NULL){
			$query->andFilterWhere ( [ 'OR' ,['like', 'cong_trinh', $cusomSearch],
        ...
        $query->andFilterWhere(['like', 'cong_trinh', $this->cong_trinh])
            ...
            ->andFilterWhere(['like', 'hieu_luc', 'CHODUYET'])
