...
/**
 * GuiYeuCauVanHanhSearch represents the model behind the search form about `app\modules\taisan\models\YeuCauVanHanh`.
 */
class GuiYeuCauVanHanhSearch extends YeuCauVanHanh
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [
                ['id', 'id_nguoi_lap', 'id_nguoi_yeu_cau', 'id_nguoi_gui', 'id_nguoi_duyet', 'id_nguoi_xuat', 'id_nguoi_nhan', 'id_bo_phan_quan_ly'],
                'integer'
            ],
            [
                ['cong_trinh', 'ngay_lap', 'ngay_gui', 'ngay_duyet', 'ngay_xuat', 'ngay_nhan', 'ly_do', 'hieu_luc', 'noi_dung_lap', 'noi_dung_gui', 'noi_dung_duyet', 'noi_dung_xuat', 'noi_dung_nhan', 'dia_diem', 'created_at', 'updated_at', 'deleted_at'],
                'safe'
            ],
        ];
    }
