...
class BoPhanBase extends \app\models\TsBoPhan
{
    ...
    public function rules()
    {
        return [
            ...
            [['truc_thuoc', 'la_dv_quan_ly', 'la_dv_su_dung', 'la_dv_bao_tri', 'la_dv_van_tai', 'la_dv_mua_hang', 'la_dv_quan_ly_kho', 'la_trung_tam_chi_phi', 'id_kho_vat_tu', 'id_kho_phe_lieu', 'id_kho_thanh_pham', 'nguoi_tao','la_dv_sua_chua'], 'integer'],
            [['thoi_gian_tao'], 'safe'],
