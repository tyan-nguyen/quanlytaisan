...
/* @var $searchModel app\modules\kholuutru\models\DmVatTuSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới danh sách vật tư','class'=>'btn btn-outline-primary']).
