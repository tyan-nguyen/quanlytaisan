...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table style="width: 100%">
    		<tr>
    			<td style="text-align: center"><span class="phieu-h1">PHIẾU SỬA CHỮA THIẾT BỊ/TÀI SẢN</span></td>
    		</tr>
    	</table>
    	...
    	<table class="table-content" style="width: 100%; margin-top:5px;">
            ...
            <tr>
            	...
            	<td style="text-align:left"><?= $item->ten_danh_muc ?></td>
    	...
    	<table id="table-ky-ten" style="width: 100%; margin-top:10px;">
    		<tr>
    			...
    			<td style="text-align:center;font-weight:bold;">TIẾP NHẬN</td>
