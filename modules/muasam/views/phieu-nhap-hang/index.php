...
/* @var $searchModel app\modules\muasam\models\PhieuNhapHangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Phieu Nhap Hangs';
...
<div class="phieu-nhap-hang-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Phieu Nhap Hangs','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách Phieu Nhap Hangs</em>',
