...
/* @var $searchModel app\modules\muasam\models\CtPhieuMuaSamVtSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ct Phieu Mua Sam Vts';
...
<div class="ct-phieu-mua-sam-vt-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Ct Phieu Mua Sam Vts','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách Ct Phieu Mua Sam Vts</em>',
