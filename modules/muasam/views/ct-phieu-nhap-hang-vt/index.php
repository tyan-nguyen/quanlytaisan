...
/* @var $searchModel app\modules\muasam\CtPhieuNhapHangVtSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ct Phieu Nhap Hang Vts';
...
<div class="ct-phieu-nhap-hang-vt-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Ct Phieu Nhap Hang Vts','class'=>'btn btn-outline-primary']).
            ...
            'panel' => [
                ...
                'before'=>'<em>* Danh sách Ct Phieu Nhap Hang Vts</em>',
