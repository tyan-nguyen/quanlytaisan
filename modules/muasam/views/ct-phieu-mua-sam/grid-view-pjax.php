...
<div class="ct-phieu-mua-sam-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                ($isUpdate ? Html::a('<i class="fas fa fa-plus" aria-hidden="true"></i> Thêm mới', ['/muasam/ct-phieu-mua-sam/create','id_phieu_mua_sam'=>$model->id],
                    ['role'=>'modal-remote','title'=> 'Thêm thiết bị','class'=>'btn btn-outline-primary']) : "").
