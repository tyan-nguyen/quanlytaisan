 ...
 */
class m240626_133402_insert_auth_item_group_data_muasam extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $data = [
            ['code' => 'quanLyPhieuMuaSam', 'name' => 'Quản lý phiếu mua sắm', 'created_at' => time(), 'updated_at' => time()]
            
        ];
        $check=AuthItemGroup::find()->where(['in','code',['quanLyPhieuMuaSam']])->count();
        if(!$check)
    ...
    {
        AuthItemGroup::deleteAll(['code' => ['quanLyPhieuMuaSam']]);
    }
