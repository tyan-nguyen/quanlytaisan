    ...
    public function run(){        
        ...
        foreach ($data as $key=>$val){
            $maHtml .= '<div class="main-img-user avatar-xl  m-2 ">
                ...
                <a class="badge rounded-pill avatar-icons bg-primary" href="'. $val->hinhAnhUrl . '" data-fancybox="gallery" data-caption="'.$val->ten_hien_thi.'" style="color:blue; inset-inline-end: 20px;"><i class="fe fe-eye fs-12 d-flex"></i></a>
