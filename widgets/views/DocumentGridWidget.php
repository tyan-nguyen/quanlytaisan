...
class DocumentGridWidget extends Widget{
	...
	<img alt="avatar" class="radius" src="'. $val->extUrl . '" data-bs-placement="top" data-bs-toggle="tooltip-primary" >
       ...
       <a class="badge rounded-pill avatar-icons bg-primary" href="'. $val->fileUrl . '" style="color:blue; inset-inline-end: 20px;" target="_blank" data-pjax="0" ><i class="fe fe-arrow-down fs-12 d-flex"></i></a>
