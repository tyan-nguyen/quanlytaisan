...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 17, 2023 at 09:52 AM
...
CREATE TABLE IF NOT EXISTS `ts_nhan_vien` (
  ...
  `ten_truy_cap` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `ts_nhan_vien` (`id`, `ma_nhan_vien`, `ten_nhan_vien`, `ngay_sinh`, `gioi_tinh`, `ten_truy_cap`, `da_thoi_viec`, `dien_thoai`, `email`, `dia_chi`, `thoi_gian_tao`, `nguoi_tao`) VALUES
(1, 'NV001', 'Nguyễn Văn A', '01/01/1989', 0, 'nvtan', 0, '0374711908', 'nguyenvantyan@gmail.com', 'ấp Dừa Đỏ 2, xã Nhị Long Phú, huyện Càng Long, tỉnh Trà Vinh.', '2023-07-17 09:41:33', 1);
