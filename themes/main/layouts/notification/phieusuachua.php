...
$dsPhieuSuaChuas=$dsPhieuSuaChua->limit(10)->all();

?>
<?php foreach($dsPhieuSuaChuas as $key => $value) { ?>
<div class="dropdown-item d-flex border-bottom pb-1 align-items-center">
    ...
    <div class="ms-12">
        <p class="mb-0 tx-14 text-dark fw-medium text-wrap"><?= 'Sửa chữa '.$value->thietBi->ten_thiet_bi ?? "" ?></p>
        <div class=" mb-0">
